...
export interface IronswornCharacterData {
  ...
  /** Progress tracks for active combat, journey, and bonds legacy. Each is 0–10. */
  tracks: { combat: number; journey: number; bonds: number }
}
...
/** Valid [min, max] ranges for each Ironsworn stat and meter. Stats cap at 3 per SRD. */
