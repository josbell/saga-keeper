...
const NPC_GOAL_TABLE = ranged('npc-goal', 'NPC Goal', 'npc', [
  ...
  [4, 6, 'Gain knowledge'],
  [7, 9, 'Gain renown'],
  [10, 12, 'Forge an alliance'],
  [13, 15, 'Claim a resource'],
  [16, 18, 'Seize power'],
  [19, 21, 'Protect themselves'],
  [22, 24, 'Protect their people'],
  [25, 27, 'Protect an artifact or place'],
  [28, 30, 'Complete a task'],
  [31, 33, 'Fulfill a duty'],
  [34, 36, 'Seek redemption'],
  [37, 39, 'Seek revenge'],
  [40, 42, 'Seek answers'],
  [43, 45, 'Seek a person'],
  [46, 48, 'Find a home'],
  [49, 51, 'Prove themselves'],
  [52, 54, 'Escape their fate'],
  [55, 57, 'Protect their faith'],
  [58, 60, 'Fulfill a prophecy'],
  [61, 63, 'Find peace'],
  [64, 66, 'Survive'],
  [67, 69, 'Maintain order'],
  [70, 72, 'Create something'],
  [73, 75, 'Destabilize a region'],
  [76, 78, 'Claim a title'],
  [79, 81, 'Return home'],
  [82, 84, 'Raise an army'],
  [85, 87, 'Spread faith'],
  [88, 90, 'Sabotage'],
  [91, 93, 'Guard a secret'],
  [94, 96, 'Resolve a conflict'],
  [97, 99, 'Exploit a resource'],
  [100, 100, 'Gain allies'],
])
...
const LOCATION_TABLE = ranged('location', 'Location', 'location', [
  ...
  [5, 8, 'Ruined Keep'],
  [9, 12, 'Sandy Beach'],
  [13, 16, 'Wooded Plateau'],
  [17, 20, 'Dense Forest'],
  [21, 24, 'Flooded Lowlands'],
  [25, 28, 'Hidden Valley'],
  [29, 32, 'Frozen Wasteland'],
  [33, 36, 'Stony Bluffs'],
  [37, 40, 'Ancient Ruins'],
  [41, 44, 'River Ford'],
  [45, 48, 'Sunken Marsh'],
  [49, 52, 'Coastal Cliff'],
  [53, 56, 'Mountain Pass'],
  [57, 60, 'Tangled Thicket'],
  [61, 64, 'Forgotten Road'],
  [65, 68, 'Abandoned Settlement'],
  [69, 72, 'Open Plains'],
  [73, 76, 'Rugged Hills'],
  [77, 80, 'Sea Cave'],
  [81, 84, 'Crumbling Tower'],
  [85, 88, 'Haunted Hollow'],
  [89, 92, 'Rocky Shoals'],
  [93, 96, 'Festering Swamp'],
...
const SETTLEMENT_TROUBLE_TABLE = ranged('settlement-trouble', 'Settlement Trouble', 'settlement', [
  [1, 10, 'Sickness or plague'],
  [11, 20, 'Danger lurks nearby'],
  [21, 30, 'Divided leadership'],
  [31, 40, 'Outsiders are unwelcome'],
  [41, 50, 'Dwindling resources'],
  [51, 60, 'Attacked or harassed'],
  [61, 70, 'A betrayal from within'],
  [71, 80, 'Cursed or haunted'],
  [81, 90, 'Monstrous threat'],
  [91, 100, 'A dark secret'],
])
...
const COMBAT_ACTION_TABLE = ranged('combat-action', 'Combat Action', 'combat', [
  [1, 3, 'Shoot or throw'],
  [4, 6, 'Strike a weak point'],
  [7, 9, 'Disarm or take their weapon'],
  [10, 12, 'Maneuver for position'],
  [13, 16, 'Charge'],
  [17, 20, 'Advance'],
  [21, 24, 'Flank'],
  [25, 28, 'Grapple'],
  [29, 32, 'Shove or trip'],
  [33, 36, 'Feint'],
  [37, 40, 'Blind with light or dirt'],
  [41, 44, 'Create a distraction'],
  [45, 48, 'Push your advantage'],
  [49, 52, 'Call for their surrender'],
  [53, 56, 'Make a show of force'],
  [57, 60, 'Withdraw'],
  [61, 64, 'Regroup'],
  [65, 68, 'Heal'],
  [69, 72, 'Bolster allies'],
  [73, 76, 'Gain the higher ground'],
  [77, 80, 'Focus on a single target'],
  [81, 84, 'Fight dirty'],
  [85, 88, 'Block or parry'],
  [89, 92, 'Take cover'],
  [93, 96, 'Await an opening'],
  [97, 100, 'All-out attack'],
])
